...
/**
 * Generate Unsplash image URL for a keyword
 */
function getContextualImage(keyword: string): string {
  ...
  // Use Unsplash Source API for free educational images
  return `https://source.unsplash.com/featured/400x300/?${query},education`
}

export function EnhancedChatDisplay({ messages, isProcessing }: EnhancedChatDisplayProps) {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-2">
                ...
                {/* Contextual images for teacher messages */}
                {isTeacher && images.length > 0 && isExpanded && (
                        ...
                        >
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.currentTarget.src = `https://placehold.co/400x300/1e293b/a855f7?text=Visual+Aid`
                            }}
                          />
                        </div>
                      ))}
