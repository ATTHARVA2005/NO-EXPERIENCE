...
function safeJsonParse<T>(raw: string, fallback: T): T {
  try {
    ...
    console.warn("[curriculum] Failed to parse model response, using fallback", error)
    return fallback
  }
}
...
[
  {
    ...
    "duration": 30,
    "completed": false,
    "content": "Complete detailed lesson plan following the 10-point structure above. Minimum 300 words. Use clear section headers.",
    "subtopics": [
      {
        "id": "subtopic-1-1",
